        ...
        data() {
            return { bg: Background, musicList: [
                    ...
                    },
                    {
                        ...
                        play_url
                            :
                            "http://music.163.com/song/media/outer/url?id=189602.mp3",
                    },
                    {
                        artists
                            :
